/**
 * Селекторы для Cash Multiplayer
 */

import { createSelector } from "@reduxjs/toolkit";
import type { RootState } from "../store";
import type { CashMultiplayerPlayer } from "../types/cashMultiplayerTypes";
import {
  isPlayerHost,
...
export const selectCurrentPlayer = createSelector(
  [selectCurrentRoom, selectCurrentUserId],
  (currentRoom, currentUserId): CashMultiplayerPlayer | undefined => {
