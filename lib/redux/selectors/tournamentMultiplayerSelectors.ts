/**
 * Селекторы для Tournament Multiplayer
 */

import { createSelector } from "@reduxjs/toolkit";
import type { RootState } from "../store";
import type { TournamentMultiplayerPlayer } from "../types/tournamentMultiplayerTypes";
import {
  isPlayerHost,
...
export const selectCurrentPlayer = createSelector(
  [selectCurrentRoom, selectCurrentUserId],
  (currentRoom, currentUserId): TournamentMultiplayerPlayer | undefined => {
